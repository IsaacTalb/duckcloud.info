        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo e(route('privacy-policy')); ?>">Privacy policy</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo e(route('services')); ?>">Web Design</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo e(route('services')); ?>">Web Development</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo e(route('services')); ?>">Product Management</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo e(route('services')); ?>">Android/IOS Development</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo e(route('portfolio')); ?>">Online Menu Orders</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo e(route('portfolio')); ?>">Software Applications</a></li>
            </ul>
          </div>
            ...
            <div class="col-lg-5 col-md-6 footer-newsletter">
                ...
                <form id="subscribe-form" action="<?php echo e(route('subscribe')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Duck_Cloud_Folders\Duck Cloud Website\duckcloud.info\resources\views/layouts/body/footer.blade.php ENDPATH**/ ?>