        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12">
            <?php if($privacyPolicy): ?>
                <h3><?php echo e($privacyPolicy->title); ?></h3>
                <img src="<?php echo e($privacyPolicy->photo); ?>" class="img-fluid" alt="">
                <p><?php echo e($privacyPolicy->text); ?></p>
...
<?php echo $__env->make('layouts.master_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Duck_Cloud_Folders\Duck Cloud Website\duckcloud.info\resources\views/pages/privacy_policy.blade.php ENDPATH**/ ?>