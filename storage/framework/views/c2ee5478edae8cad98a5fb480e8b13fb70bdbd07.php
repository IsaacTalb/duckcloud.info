                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="<?php echo e(Auth::user()->profile_photo_url); ?>" class="user-image" alt="User Image" />
                      <span class="d-none d-lg-inline-block"><?php echo e(Auth::user()->name); ?></span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="<?php echo e(Auth::user()->profile_photo_url); ?>" class="img-circle" alt="User Image" />
                      ...
                      <li>
                        <a href="<?php echo e(route('dashboard')); ?>">
                          <i class="mdi-monitor-dashboard"></i> Dashboard
                        </a>
                      </li>
                      <li>
                        <a href="<?php echo e(route('profile.update')); ?>">
                      ...
                      <li>
                        <a href="<?php echo e(route('user.logout')); ?>"> <i class="mdi mdi-logout"></i> Log Out </a>
                      </li>
                    </ul>
                  </li>
                </ul>
...
<script src="<?php echo e(asset('backend/assets/plugins/toaster/toastr.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/slimscrollbar/jquery.slimscroll.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/charts/Chart.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/ladda/spin.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/ladda/ladda.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/jquery-mask-input/jquery.mask.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/select2/js/select2.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/jvectormap/jquery-jvectormap-world-mill.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/daterangepicker/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/daterangepicker/daterangepicker.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/plugins/jekyll-search.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/js/sleek.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/js/chart.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/js/date-range.js')); ?>"></script>
<script src="<?php echo e(asset('backend/assets/js/map.js')); ?>"></script>
...
<?php /**PATH D:\Duck_Cloud_Folders\Duck Cloud Website\duckcloud.info\resources\views/admin/admin_master.blade.php ENDPATH**/ ?>