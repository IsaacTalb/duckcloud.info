...
<html lang="en" dir="ltr">
  ...
  <link rel="icon" href="{{ asset('frontend/assets/img/dc_logo.png') }}" sizes="16x16" type="image/png">
  <link rel="apple-touch-icon" href="{{ asset('frontend/assets/img/dc_logo.png') }}">
  <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('frontend/assets/img/dc_logo.png') }}">
  <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('frontend/assets/img/dc_logo.png') }}">
  <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('frontend/assets/img/dc_logo.png') }}">
  ...
  <meta property="og:image" content="{{ asset('frontend/assets/img/dc_logo.png') }}">
