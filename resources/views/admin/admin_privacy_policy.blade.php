                            ...
                            <tbody>
                                ...
                                @foreach($privacyPolicies as $policy)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('privacy-policy/edit/'.$policy->id) }}" class="btn btn-info">Edit</a>
                                            <a href="{{ url('privacy-policy/delete/'.$policy->id) }}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
